...
admins = { "reza@cloud99p.org" }

contact_info = {
	abuse = { "mailto:abuse@cloud99p.org", "xmpp:reza@cloud99p.org" };
	support = { "mailto:support@cloud99p.org", "xmpp:reza@cloud99p.org" };
}
...
-- Force clients to use encrypted connection? This option will
-- prevent clients from authentication unless they are using encryption.
...
Component "xmpp.cloud99p.org" "muc"
...
Component "share.cloud99p.org" "http_file_share"

http_file_share_size_limit = 20 * 1024 * 1024 -- 20MB
http_file_share_expire_after = 60 * 60 * 24 * 30 -- 30 days in sec
